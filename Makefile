...
APP_NAME = dsd_iot_sdk_unit_tests
...
MOCKS_SRC += $(APP_DIR)/tls_mock/dsd_iot_tests_unit_mock_tls_params.c
MOCKS_SRC += $(APP_DIR)/tls_mock/dsd_iot_tests_unit_mock_tls.c
