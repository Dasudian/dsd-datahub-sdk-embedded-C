...
/**
 * @file dsd_iot_jobs_json.h
 * @brief Functions for mapping between json and the DSD Iot Job data structures.
 */
...
#ifndef DSD_IOT_JOBS_JSON_H_
#define DSD_IOT_JOBS_JSON_H_
 ...
 *   been truncated.
 */
int dsd_iot_jobs_json_serialize_update_job_execution_request(
 ...
 *   been truncated.
 */
int dsd_iot_jobs_json_serialize_client_token_only_request(
		char *requestBuffer, size_t bufferSize,
 ...
 *   been truncated.
 */
int dsd_iot_jobs_json_serialize_describe_job_execution_request(
		char *requestBuffer, size_t bufferSize,
 ...
 *   been truncated.
 */
int dsd_iot_jobs_json_serialize_start_next_job_execution_request(
		char *requestBuffer, size_t bufferSize,
