...
/**
 * @file dsd_iot_jobs_types.h
 * @brief Structures defining the interface with the DSD IoT Jobs system
 *
 * This file defines the structures returned by and sent to the DSD IoT Jobs system.
 *
 */
...
#ifndef DSD_IOT_JOBS_TYPES_H_
#define DSD_IOT_JOBS_TYPES_H_
 ...
 */
JobExecutionStatus dsd_iot_jobs_map_string_to_job_status(const char *str);
 ...
 */
const char *dsd_iot_jobs_map_status_to_string(JobExecutionStatus status);
