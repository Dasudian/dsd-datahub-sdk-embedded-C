...
/**
 * @file dsd_iot_mqtt_interface.h
 * @brief Interface definition for MQTT client.
 */

#ifndef DSD_IOT_SDK_SRC_IOT_MQTT_INTERFACE_H
#define DSD_IOT_SDK_SRC_IOT_MQTT_INTERFACE_H
...
*
* @param pClient MQTT Client that was previously created by calling dsd_iot_mqtt_init
