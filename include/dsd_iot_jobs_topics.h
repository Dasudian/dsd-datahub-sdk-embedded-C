...
/**
 * @file dsd_iot_job_topics.h
 * @brief Functions for parsing and creating MQTT topics used by the DSD IoT Jobs system.
 */
...
#ifndef DSD_IOT_JOBS_TOPICS_H_
#define DSD_IOT_JOBS_TOPICS_H_
 ...
 */
int dsd_iot_jobs_get_api_topic(char *buffer, size_t bufferSize,
