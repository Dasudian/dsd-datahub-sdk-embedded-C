...
/**
 * @file dsd_iot_jobs_interface.h
 * @brief An interface for interacting with the DSD IoT Jobs system.
 *
 * This file defines utility functions for interacting with the DSD IoT jobs
 ...
 */
#ifndef DSD_IOT_JOBS_INTERFACE_H_
#define DSD_IOT_JOBS_INTERFACE_H_
...
/**
 * @file dsd_iot_jobs_interface.h
 * @brief Functions for interacting with the DSD IoT Jobs system.
 */
#include "dsd_iot_mqtt_client_interface.h"
#include "dsd_iot_jobs_topics.h"
#include "dsd_iot_jobs_types.h"
#include "dsd_iot_error.h"
#include "dsd_iot_json_utils.h"
 ...
 *
 * See also #dsd_iot_jobs_subscribe_to_all_job_messages to subscribe to all possible
 ...
 *   dsd_iot_jobs_unsubscribe_from_job_messages is called.
 * \param topicBuffer. A buffer to use to hold the topic name for the subscription. This buffer
 *   must remain valid at least until dsd_iot_jobs_unsubscribe_from_job_messages is called.
 * \param topicBufferSize the size of the topic buffer. The function will fail
 *   with LIMIT_EXCEEDED_ERROR if this is too small.
 * \return the result of subscribing to the topic (see dsd_iot_mqtt_subscribe)
 */
 ...
 *
 * Remove the subscription created using #dsd_iot_jobs_subscribe_to_job_messages or
 *   #dsd_iot_jobs_subscribe_to_all_job_messages.
 *
 * \param pClient the client to use
 * \param topicBuffer the topic buffer passed to #dsd_iot_jobs_subscribe_to_job_messages or
 *   #dsd_iot_jobs_subscribe_to_all_job_messages when the subscription was created.
...
#endif /* DSD_IOT_JOBS_INTERFACE_H_ */
