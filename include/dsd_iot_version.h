 ...
 * This file is modified by DSD upon release of the SDK and should not be
 ...
 * @see http://semver.org/
 */
#ifndef SRC_UTILS_DSD_IOT_VERSION_H_
#define SRC_UTILS_DSD_IOT_VERSION_H_
...
#endif /* SRC_UTILS_DSD_IOT_VERSION_H_ */
