...
// Get from console
// =================================================
#define DSD_IOT_MQTT_HOST              "datahub.dsdiot.com" ///< Customer specific MQTT HOST. Make usre with Dasudian Tech Team>
...
#define SHADOW_MAX_SIZE_OF_RX_BUFFER (DSD_IOT_MQTT_RX_BUF_LEN+1) ///< Maximum size of the SHADOW buffer to store the received Shadow message, including terminating NULL byte.
