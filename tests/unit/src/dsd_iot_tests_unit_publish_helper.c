...
/**
 * @file dsd_iot_tests_unit_publish_helper.c
...
TEST_C(PublishTests, PublishNullClient) {
	...
	rc = dsd_iot_mqtt_publish(NULL, "sdkTest/Sub", 11, &testPubMsgParams);
...
TEST_C(PublishTests, PublishNullTopic) {
	...
	rc = dsd_iot_mqtt_publish(&iotClient, NULL, 11, &testPubMsgParams);
	CHECK_EQUAL_C_INT(NULL_VALUE_ERROR, rc);

	rc = dsd_iot_mqtt_publish(&iotClient, "sdkTest/Sub", 0, &testPubMsgParams);
	CHECK_EQUAL_C_INT(NULL_VALUE_ERROR, rc);
...
TEST_C(PublishTests, PublishNullParams) {
	...
	rc = dsd_iot_mqtt_publish(&iotClient, "sdkTest/Sub", 11, NULL);
	CHECK_EQUAL_C_INT(NULL_VALUE_ERROR, rc);
	...
	rc = dsd_iot_mqtt_publish(&iotClient, "sdkTest/Sub", 11, &testPubMsgParams);
	CHECK_EQUAL_C_INT(NULL_VALUE_ERROR, rc);
...
TEST_C(PublishTests, publishQoS1FailureToReceivePuback) {
	...
	rc = dsd_iot_mqtt_publish(&iotClient, subTopic, subTopicLen, &testPubMsgParams);
