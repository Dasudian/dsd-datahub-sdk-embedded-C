...
TEST_C(JobsJsonTests, SerializeUpdateRequest) {
	...
	char buffer[256];
	int charsUsed = dsd_iot_jobs_json_serialize_update_job_execution_request(buffer, sizeof(buffer), &updateRequest);
...
TEST_C(JobsJsonTests, SerializeUpdateRequestWithNullBuffer) {
	...
	int charsUsed = dsd_iot_jobs_json_serialize_update_job_execution_request(NULL, 0, &updateRequest);
	CHECK_EQUAL_C_INT((int)strlen(defaultUpdateRequestSerialized), charsUsed);
...
TEST_C(JobsJsonTests, SerializeUpdateRequestWithTooSmallBuffer) {
	...
	int charsUsed = dsd_iot_jobs_json_serialize_update_job_execution_request(buffer, 10, &updateRequest);
	CHECK_EQUAL_C_INT((int)strlen(defaultUpdateRequestSerialized), charsUsed);
...
TEST_C(JobsJsonTests, SerializeDescribeJobExecutionRequest) {
	...
	char buffer[256];
	int charsUsed = dsd_iot_jobs_json_serialize_describe_job_execution_request(buffer, 256, &describeJobExecutionRequest);
...
TEST_C(JobsJsonTests, SerializeDescribeJobExecutionRequestWithNullBuffer) {
	...
	int charsUsed = dsd_iot_jobs_json_serialize_describe_job_execution_request(NULL, 0, &describeJobExecutionRequest);
...
TEST_C(JobsJsonTests, SerializeDescribeJobExecutionRequestWithTooSmallBuffer) {
	...
	int charsUsed = dsd_iot_jobs_json_serialize_describe_job_execution_request(buffer, 10, &describeJobExecutionRequest);
	CHECK_EQUAL_C_INT((int)strlen(defaultDescribeJobExecutionRequestSerialized), charsUsed);
...
TEST_C(JobsJsonTests, SerializeStartNextRequest) {
	...
	char buffer[256];
	int charsUsed = dsd_iot_jobs_json_serialize_start_next_job_execution_request(buffer, 256, &startNextRequest);
...
TEST_C(JobsJsonTests, SerializeStartNextRequestWithNullBuffer) {
	...
	int charsUsed = dsd_iot_jobs_json_serialize_start_next_job_execution_request(NULL, 0, &startNextRequest);
	CHECK_EQUAL_C_INT((int)strlen(defaultStartNextRequestSerialized), charsUsed);
...
TEST_C(JobsJsonTests, SerializeStartNextRequestWithTooSmallBuffer) {
	...
	int charsUsed = dsd_iot_jobs_json_serialize_start_next_job_execution_request(buffer, 10, &startNextRequest);
	CHECK_EQUAL_C_INT((int) strlen(defaultStartNextRequestSerialized), charsUsed);
