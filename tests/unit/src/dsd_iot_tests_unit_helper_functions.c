...
/**
 * @file dsd_iot_tests_unit_helper_functions.c
...
void InitMQTTParamsSetup(IoT_Client_Init_Params *params, char *pHost, uint16_t port, bool enableAutoReconnect,
	...
	params->pDeviceCertLocation = DSD_IOT_ROOT_CA_FILENAME;
	params->pDevicePrivateKeyLocation = DSD_IOT_CERTIFICATE_FILENAME;
	params->pRootCALocation = DSD_IOT_PRIVATE_KEY_FILENAME;
}
